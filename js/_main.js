...
CLOE_BROOKS_STORAGE["site_url"] = "https://cloe-brooks-html.themerex.net";
...
CLOE_BROOKS_STORAGE["email_mask"] =
...
// template parameters
if (typeof CLOE_BROOKS_STORAGE == "undefined") var CLOE_BROOKS_STORAGE = {};
if (CLOE_BROOKS_STORAGE["theme_font"] == "")
  CLOE_BROOKS_STORAGE["theme_font"] = "Aller";
CLOE_BROOKS_STORAGE["theme_skin_color"] = "#33302e";
CLOE_BROOKS_STORAGE["theme_skin_bg_color"] = "#ffffff";
...
window._wpemojiSettings = {
  ...
  source: {
    concatemoji:
      "https://cloe-brooks.themerex.net/wp-includes/js/wp-emoji-release.min.js?ver=4.5.4",
  },
};
...
!(function (a, b, c) {
  ...
  function d(a) {
    ...
    switch (((g.textBaseline = "top"), (g.font = "600 32px Arial"), a)) {
      ...
      case "simple":
        return (
          g.fillText(h(55357, 56835), 0, 0),
          0 !== g.getImageData(16, 16, 1, 1).data[0]
        );
      case "unicode8":
        return (
          g.fillText(h(55356, 57135), 0, 0),
          0 !== g.getImageData(16, 16, 1, 1).data[0]
        );
    }
    return !1;
  ...
  var f, g, h, i;
  for (
    i = Array("simple", "flag", "unicode8", "diversity"),
      c.supports = {
        everything: !0,
